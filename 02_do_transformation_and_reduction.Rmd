...
setwd("temp_files/")
temp_data_storage <- "do_focus_processed.RData"
do_focus_collection <- readRDS(temp_data_storage)
```
...
do_focus_collection$features_df$custom_selection <- do_focus_collection$features_df$name_ %in% custom_feature_selection
```

# Save/overwrite RDS

```{r}
temp_data_storage <- paste0("temp_files/do_focus_reduced.RData")
